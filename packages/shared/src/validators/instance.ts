...
export const instanceExperimentalSettingsSchema = z.object({
  ...
  issueGraphLivenessRecoverySpawnSuppressionWindowMinutes: z
    .number()
    .int()
    .min(MIN_ISSUE_GRAPH_LIVENESS_RECOVERY_SPAWN_SUPPRESSION_WINDOW_MINUTES)
    .max(MAX_ISSUE_GRAPH_LIVENESS_RECOVERY_SPAWN_SUPPRESSION_WINDOW_MINUTES)
    .default(DEFAULT_ISSUE_GRAPH_LIVENESS_RECOVERY_SPAWN_SUPPRESSION_WINDOW_MINUTES),
}).strict();

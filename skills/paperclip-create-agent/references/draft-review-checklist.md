...
- [ ] For `Coder` hires, `desiredSkills` includes the seven-skill default bundle in the order documented in `references/agents/coder.md`; any omission or addition is justified in the hire comment
